...
SECRET_KEY = 'django-insecure-=^)h192jvg#))p4io&^onsq*j$eiz83%s-))fa47$hx*9)(%i6'
...
DATABASES['default'] = dj_database_url.parse('mysql://postgres://bljjbxvy:***@cornelius.db.elephantsql.com/bljjbxvy ')
